    ...
    <h1 className='sectionTitle' style={{
        ...
        <div className='row'>
          ...
          <p style={{
            ...
            Nosotros le brindaremos la atención necesaria a tus pequeños de modo de hacer de la salud bucal un proyecto de vida; al proveerle a tus hijos las herramientas necesarias para que aprendan a cuidar de su boca de acuerdo a su edad.
          </p>
          </div>
        </div>
        <div style={{
